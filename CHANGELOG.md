...
- Pure `DBCP_VCard_Builder` with PHPUnit tests for escaping, folding, line endings, TEL types and PHOTO embedding, plus a phpqrcode smoke test (skipped without GD; `bin/test-docker.sh` runs it in a container).
